...
export default function Home() {
  return (
    <div className="flex flex-col bg-black">
      ...
      <div className="h-[30rem] flex flex-col justify-center gap-4 bg-pink-950 text-white" id="projetos">
        <div className="flex items-center justify-center">
          <Card />
        </div>
      </div>

      <div className="min-h-[35rem] pl-16 flex justify-center items-center bg-black text-white">
        <div className="flex flex-col w-[50%]">
          <div className="flex flex-col gap-2 h-auto bg-slate-950 opacity-70 p-6">
      ...
      <div className="min-h-[40rem] flex flex-col justify-center items-center bg-black text-white">
